...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      // Replace the real @enclave/ui-shell with a budget-only stub.
      ...
      // server `@` is aliased to budget's client dir → import failures.
      //
      // The stub is a self-contained EnclaveNav that only renders the budget
