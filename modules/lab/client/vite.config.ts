...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      // Replace the real @enclave/ui-shell with a lab-only stub.
      ...
      // server `@` is aliased to lab's client dir → import failures.
      //
      // The stub is a self-contained EnclaveNav that only renders the lab
